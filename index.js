...
global.loadDatabase = async function loadDatabase() {
  ...
  for (const file of settingsFiles) {
    ...
    const settingDb = new Low(
      new JSONFile(getFilePath(settingsPath, settingId))
    );
  ...
  for (const file of stickerFiles) {
    ...
    const stickerDb = new Low(
      new JSONFile(getFilePath(stickerPath, stickerId))
    );
...
global.db.save = async function saveDatabase() {
  ...
  for (const [stickerId, stickerData] of Object.entries(
...
┊ ${chalk.blueBright("┊")} ${chalk.blue.bgBlue.bold.cyan(
      lenguajeGB["methodCode1"]()
    )}
┊ ${chalk.blueBright("╰┅┅┅┅┅┅┅┅┅┅┅┅┅┅┅")}   
┊ ${chalk.blueBright("╭┅┅┅┅┅┅┅┅┅┅┅┅┅┅┅")}     
┊ ${chalk.blueBright("┊")} ${chalk.green.bgMagenta.bold.yellow(
      lenguajeGB["methodCode2"]()
    )}
┊ ${chalk.blueBright("┊")} ${chalk.bold.redBright(
      `⇢  ${lenguajeGB["methodCode3"]()} 1:`
    )} ${chalk.greenBright(lenguajeGB["methodCode4"]())}
┊ ${chalk.blueBright("┊")} ${chalk.bold.redBright(
      `⇢  ${lenguajeGB["methodCode3"]()} 2:`
    )} ${chalk.greenBright(lenguajeGB["methodCode5"]())}
┊ ${chalk.blueBright("╰┅┅┅┅┅┅┅┅┅┅┅┅┅┅┅")}
┊ ${chalk.blueBright("╭┅┅┅┅┅┅┅┅┅┅┅┅┅┅┅")}     
...
┊ ${chalk.blueBright("╰┅┅┅┅┅┅┅┅┅┅┅┅┅┅┅")} 
┊ ${chalk.blueBright("╭┅┅┅┅┅┅┅┅┅┅┅┅┅┅┅")}    
┊ ${chalk.blueBright("┊")} ${chalk.red.bgRed.bold.green(
      lenguajeGB["methodCode8"]()
    )}
┊ ${chalk.blueBright("┊")} ${chalk.italic.cyan(lenguajeGB["methodCode9"]())}
┊ ${chalk.blueBright("┊")} ${chalk.italic.cyan(lenguajeGB["methodCode10"]())}
┊ ${chalk.blueBright("┊")} ${chalk.bold.yellow(
      `npm run qr ${chalk.italic.magenta(`(${lenguajeGB["methodCode12"]()})`)}`
    )}
┊ ${chalk.blueBright("┊")} ${chalk.bold.yellow(
      `npm run code ${chalk.italic.magenta(
        `(${lenguajeGB["methodCode13"]()})`
      )}`
    )}
┊ ${chalk.blueBright("┊")} ${chalk.bold.yellow(
      `npm start ${chalk.italic.magenta(`(${lenguajeGB["methodCode14"]()})`)}`
    )}
┊ ${chalk.blueBright("╰┅┅┅┅┅┅┅┅┅┅┅┅┅┅┅")} 
...
console.warn = function () {
  ...
  if (
    ...
    (message.includes(atob("Q2xvc2luZyBzdGFsZSBvcGVu")) ||
      message.includes(atob("Q2xvc2luZyBvcGVuIHNlc3Npb24=")))
  ) {
    arguments[0] = "";
  }
...
console.error = function () {
  ...
  if (
    typeof message === "string" &&
    (message.includes(atob("RmFpbGVkIHRvIGRlY3J5cHQ=")) ||
      message.includes(atob("U2Vzc2lvbiBlcnJvcg==")))
  ) {
    arguments[0] = "";
  }
      ...
      if (!!phoneNumber) {
        ...
        do {
          phoneNumber = await question(
            chalk.bgBlack(
              chalk.bold.greenBright(lenguajeGB["phNumber2"](chalk))
            )
          );
        ...
        setTimeout(async () => {
          ...
          console.log(
            chalk.bold.white(chalk.bgMagenta(lenguajeGB["pairingCode"]())),
    ...
    if (reason === DisconnectReason.badSession) {
      ...
      console.log(
        chalk.bold.redBright(
          lenguajeGB["smsConexiondescon"](reason, connection)
        )
      );
    }
  }
  ...
  try {
    ...
    listaDirectorios.forEach((directorio) => {
      if (statSync(`./LynxJadiBot/${directorio}`).isDirectory()) {
        const DSBPreKeys = readdirSync(`./LynxJadiBot/${directorio}`).filter(
          (fileInDir) => {
        ...
        if (file !== "creds.json") {
          ...
          unlinkSync(filePath, (err) => {
            if (err) {
              console.log(
                chalk.bold.red(
                  `${lenguajeGB.smspurgeOldFiles3()} ${file} ${lenguajeGB.smspurgeOldFiles4()}` +
                    err
                )
              );
            } else {
              console.log(
                chalk.bold.green(
                  `${lenguajeGB.smspurgeOldFiles1()} ${file} ${lenguajeGB.smspurgeOldFiles2()}`
                )
              );
            }
          });
